  ...
  worldpayOrSandboxGoogleAuthRequestDetails: (ops = {}) => {
    const data = {
      ...
      encrypted_payment_data: {
        signature: 'MEQCIB54h8T/hWY3864Ufkwo4SF5IjhoMV9hjpJRIsqbAn4LAiBZz1VBZ+aiaduX8MN3dBtzyDOZVstwG/8bqJZDbrhKfQ=', // pragma: allowlist secret
  ...
  appleAuthRequestDetails: (ops = {}) => {
    ...
    const data = {
      payment_info: {
        ...
        brand: 'master-card',
        cardholder_name: 'Some Name',
        display_name: 'MasterCard ' + lastDigitsCardNumber,
        network: 'MasterCard',
        transaction_identifier: '2686f5297f123ec7fd9d31074d43d201953ca75f098890375f13aed2737d92f2'
      },
      payment_data: '{"version":"EC_v1","data":""' + // pragma: allowlist secret
        ...
        ',"header":{"ephemeralPublicKey":"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEMwliotf2ICjiMwREdqyHSilqZzuV2fZey86nBIDlTY8sNMJv9CPpL5/DKg4bIEMe6qaj67mz4LWdr7Er0Ld5qA==","publicKeyHash":"LbsUwAT6w1JV9tFXocU813TCHks+LSuFF0R/eBkrWnQ=","transactionId":"2686f5297f123ec7fd9d31074d43d201953ca75f098890375f13aed2737d92f2"}}' // pragma: allowlist secret
    }
    if (ops.email) {
