...
describe.only('secure controller', function () {
  describe.only('get method', function () {
    ...
    describe.only('when the token is invalid', function () {
    ...
    describe.only('when the token is valid', function () {
      describe.only('and not marked as used successfully', function () {
      ...
      describe.only('and the token is marked as used successfully', function () {
      ...
      describe.only('and the token has been used and the frontend state cookie is empty', function () {
        it('should display the "Your payment session has expired" page', async function () {
      ...
      describe.only('and the token has been used and the frontend state cookie is not present', function () {
        it('should display the "Your payment session has expired" page', async function () {
      ...
      describe.only('and the token has been used and the frontend state cookie contains the ID of the payment associated with the token', function () {
