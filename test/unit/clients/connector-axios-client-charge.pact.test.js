...
describe.only('Connector client - charge tests', function () {
  ...
  describe.only('Authorisation request success', function () {
  ...
  describe.only('Authorisation request without a billing address success', function () {
  ...
  describe.only('Find charge success', function () {
    before(() => {
