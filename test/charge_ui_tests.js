...
describe('The charge view', function () {
  ...
  it('should have a \'Continue\' button.', function (done) {
    renderTemplate('charge', {}, function (err, body) {
      if (err) done(err)
  ...
  it('should show all input fields.', function (done) {
    renderTemplate('charge', {'id': '1234'}, function (err, body) {
      if (err) done(err)
  ...
  it('should populate form data if reserved in response', function (done) {
    var responseData = {
      'id': '1234',
    ...
    renderTemplate('charge', responseData, function (err, body) {
      if (err) done(err)
...
describe('The confirm view', function () {
  ...
  it('should render cardNumber, expiryDate, amount and cardholder details fields', function (done) {
    renderTemplate('confirm', successTemplateData, function (err, body) {
      if (err) done(err)
  ...
  it('should render a confirm button', function (done) {
    renderTemplate('confirm', {confirmPath: '/card_details/123/confirm', 'charge': {id: 1234}}, function (err, body) {
      if (err) done(err)
  ...
  it('should have a cancel form.', function (done) {
